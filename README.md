...
# [CBRS-projects-map](https://www.fws.gov/cbra/Maps/Mapper.html)

The Coastal Barrier Resources System (CBRS) mapper can be used to help property owners, local, State, and Federal stakeholders, and the public determine whether or not properties or project sites may be affected by CBRA.
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/USGS-WiM/CBRS-projects-map/tags).
...
See also the list of [contributors](https://github.com/USGS-WiM/CBRS-projects-map/contributors) who participated in this project.
